...
public class ViewStudents extends javax.swing.JFrame {
    ...
    public static HashMap<String, StudentUpdate> studentUpdateMap = new HashMap();
    ...
    private void loadStudents() {
        try {
            ResultSet resultSet = MySQL.execute("SELECT * FROM `student` INNER JOIN"
                    + "`class` ON `student`.`class_class_id`=`class`.`class_id`");
            ...
            while (resultSet.next()) {
                ...
                student.setStudentMiddleName(resultSet.getString("middle_name"));
                student.setStudentLastName(resultSet.getString("last_name"));
                studentUpdateMap.put(resultSet.getString("student_id"), student);
    ...
    private void initComponents() {
        ...
        jButton3.setText("Edit selected student");
        ...
        jButton4.setText("Remove selected student");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "First Name", "Last Name", "NIC Number", "Mobile No", "Class"
            }
        ) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (selectRow == -1) {
            ...
            String studentName = String.valueOf(jTable1.getValueAt(selectRow, 1));
            ...
            try {
                ...
                loadStudents();
                JOptionPane.showMessageDialog(this, "" + studentName + " deleted! ", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (selectRow == -1) {
            ...
            UpdateStudents details = new UpdateStudents();
            details.jTextField5.setText(studentId);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 1) {
            ...
            String studentNic = String.valueOf(jTable1.getValueAt(selectedRow, 2));
            jTextField2.setText(studentNic);
        }
