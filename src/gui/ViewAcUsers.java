 ...
 * @author thari
 */
public class ViewAcUsers extends javax.swing.JFrame {
    ...
    private void loadAcademicUser() {
        try {
            ResultSet resultSet = MySQL.execute("SELECT * FROM `academic_user`");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ACADEMIC USERS");
        ...
        jButton4.setText("Remove selected user");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User ID", "First Name", "NIC Number", "Email", "Mobile No"
            }
        ) {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        RegAcUsers registerAcademicUsers = new RegAcUsers();
        registerAcademicUsers.setVisible(true);
        this.dispose();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (selectRow == -1) {
            ...
            JOptionPane.showMessageDialog(this, "Please Select a User", "Warning", JOptionPane.ERROR_MESSAGE);
        } else {
            String userId = String.valueOf(jTable1.getValueAt(selectRow, 0));
            String userName = String.valueOf(jTable1.getValueAt(selectRow, 1));

            try {

                MySQL.execute("DELETE FROM `academic_user` WHERE `user_id`='" + userId + "'");

                loadAcademicUser();
                JOptionPane.showMessageDialog(this, "" + userName + " deleted! ", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAcUsers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAcUsers().setVisible(true);
            }
        });
    }
