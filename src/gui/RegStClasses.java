 ...
 * @author thari
 */
public class RegStClasses extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Add students for classes");
        ...
        jButton2.setText("Register student to class");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegStClasses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegStClasses().setVisible(true);
            }
        });
    }
