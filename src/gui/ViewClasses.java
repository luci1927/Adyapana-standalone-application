...
public class ViewClasses extends javax.swing.JFrame {
    ...
    private void loadClasses() {
        try {
            ...
            while (resultSet.next()) {
                ...
                v.add(resultSet.getString("class_id"));
    ...
    private void initComponents() {
        ...
        jButton3.setText("Update selected class");
        ...
        jButton4.setText("Delete selected class");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (selectRow == -1) {
            ...
            String className = String.valueOf(jTable1.getValueAt(selectRow, 1));

            try {

                MySQL.execute("DELETE FROM `class` WHERE `class_id`='" + classId + "'");

                loadClasses();
                JOptionPane.showMessageDialog(this, "" + className + " deleted! ", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (selectRow == -1) {
            ...
            try {
                ...
                UpdateClass updateClass = new UpdateClass(classId, className);
