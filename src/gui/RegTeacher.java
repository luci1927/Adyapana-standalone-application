...
public class RegTeacher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adyapana Institute | TEACHER Registration...");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        jLabel2.setText("Add Teacher details here");
        ...
        jLabel15.setText("Teacher ID be like TEA-Year-4 digit number");
        ...
        if (teacherID.isEmpty()) {
            ...
            try {
                ...
                MySQL.execute("INSERT INTO "
                        + "`teacher`(`teacher_id`,`name_title_id`,`surname`,`first_name`,`middle_name`,`last_name`,`nic`,`mobile_no`,"
                        + "`tel_no`,`email`,`other_subjects`,`no`,`line1`,`line2`,`city`,`gender_id`,`district_id`,`marital_status_id`,`subjects_subject_id`)"
                        + " VALUES ('" + teacherID + "','" + titleId + "','" + surname + "','" + firstName + "','" + middleName + "',"
                        + "'" + lastName + "','" + nic + "','" + mobileNo + "','" + telNo + "','" + email + "','" + otherSubject + "','" + no + "','" + line1 + "',"
                        + "'" + line2 + "','" + city + "','" + genderId + "','" + districtId + "','" + maritalStatusId + "','" + subjectId + "')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegTeacher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
